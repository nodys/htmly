...
exports.toAsync = function (fn) {
  ...
  return function () {
    ...
    if (typeof (result) !== 'undefined') {
      doneOnce(null, result)
    }
  }
}

/**
 * Extract htmly configuration from a package.json
 *
 ...
 */
exports.getHtmlyConfig = function (pkg) {
  if (!pkg) {
  ...
  return pkg.browserify.transform.reduce(function (memo, item) {
      ...
      if ((typeof (item) === 'string') || (item[0] !== 'htmly') || !item[1]) {
        return
      } else {
        return item[1]
      }
